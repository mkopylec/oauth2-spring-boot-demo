...
import static com.github.mkopylec.oauth2.resourceserver.ResourceController.INVALID_AUTHORITY_PROTECTED_RESOURCE_URI;
...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(INVALID_AUTHORITY_PROTECTED_RESOURCE_URI).hasAuthority("user");
    }
}
